...
const TrainingCard = ({ data, openTrainingCard }) => {
    ...
    const cardClasses = `card card-compact mx-0.5 bg-gray-900 max-w-40 min-w-20 min-h-20 rounded-br-none rounded-bl-none rounded-tr-none ring-1 hover:ring-2 cursor-pointer overflow-clip  ${
        ...
        <div className={cardClasses} onClick={openTrainingCard}>
            <div className="flex flex-col justify-start overflow-clip">
                ...
                <div className="mx-3 mt-3 mb-1 flex flex-col gap-0 justify-start text-xs">
                    {type && (
                        <div className="card-title text-xs md:text-sm mt-1">
                            {type}
                        </div>
                    )}
